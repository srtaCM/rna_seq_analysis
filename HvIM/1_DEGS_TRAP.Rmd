...
cat("H vs UM:", sum(res_H_UM$padj < 0.05, na.rm = TRUE), "DE genes at padj < 0.05\n")
cat("IM vs UM:", sum(res_IM_UM$padj < 0.05, na.rm = TRUE), "DE genes at padj < 0.05\n")
```
