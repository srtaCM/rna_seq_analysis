...
if (!dir.exists(graphics_dir)) {
  graphics_dir <- file.path(project_root, "/Results/Graphics")
}
...
procdata_dir <- params$procdata_dir %||% file.path(project_root, "/Results/Processed_data")
