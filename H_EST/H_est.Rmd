...
# read.count strip ".bam" suffix
read.count_basenames <- str_remove(colnames(read.count), "\\.bam.*$")

# gfp summaries 
gfp1_9_basenames <- gfp1_9_summary$sample_id
gfp10_11_basenames <- gfp10_11_summary$sample_id

## Verify they now match exactly
all(read.count_basenames == gfp1_9_basenames)  # TRUE
...
```{r}
# % GFP1-9 reads = estimated 35S contamination in IM
